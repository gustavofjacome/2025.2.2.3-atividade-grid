...
- [x] Cada projeto deve conter:
  ...
  - [x] Título do projeto
  - [x] Breve descrição
  - [x] Link (pode ser fictício) (Usei links reais)
...
- [x] Links funcionais (podem apontar para perfis reais ou fictícios) (usei links reais)
...
- [x] Adicionar seção de contato com formulário
- [x] Utilizar variáveis CSS (Custom Properties)
